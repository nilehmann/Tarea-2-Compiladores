...
public class DumpVisitor implements ASTVisitor<Void, Void, PrintStream, Integer> {
	...
	public Void visit(Cases cases, PrintStream out, Integer n) {
		for (Iterator<SingleNode> e = cases.getElements(); e.hasNext();)
			e.next().accept(this, out, n);
