...
public interface ASTVisitor<R, R2, P1, P2> {
	/*Lists*/
	public R2 visit(Classes classes, P1 arg1, P2 arg2);
	public R2 visit(Features features, P1 arg1, P2 arg2);
	public R2 visit(Formals formals, P1 arg1, P2 arg2);
	public R2 visit(Expressions exprs, P1 arg1, P2 arg2);
	public R2 visit(Cases cases, P1 arg1, P2 arg2);	
